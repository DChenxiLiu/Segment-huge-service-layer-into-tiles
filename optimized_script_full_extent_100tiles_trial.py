...
# this is the script for processing of imagery tiles, but this one turns out to have a more optimized approach. Because it will generated lots of no data area/
